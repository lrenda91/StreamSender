...
import static it.polito.mad.streamsender.net.ws.WebSocketState.*;
 ...
 * ws.{@link #addListener(WebSocketListener) addListener}(new @WebSocketAdapter() {
...
public class WebSocket
{
    ...
    void onWritingThreadStarted()
    {
        ...
        try {
            TrafficStats.tagSocket(getSocket());
    ...
    {
        try {
            TrafficStats.untagSocket(getSocket());
        } catch (SocketException e) {
            e.printStackTrace();
        }
